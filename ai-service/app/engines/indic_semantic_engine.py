...
BLENDABLE_CATEGORIES = ["fear", "threat", "hopelessness", "isolation", "vulnerability", "caste_targeting", "sexual_violence", "custodial_abuse", "bonded_labor", "land_displacement", "child_marriage", "digital_harassment", "manual_scavenging", "public_humiliation", "public_access_denial"]
